		...
		if ( over ) {
			if ( over.data.current.accepts.includes(active.data.current.type) ) {
				...
				setFeedback({
					            phase1: sintactic ? {
						            ...
						            ...feedback.phase1, incorrectPosSemantic: feedback?.phase1?.incorrectPosSemantic == null ? 1 : feedback?.phase1?.incorrectPosSemantic + 1
					            } : {
			...
			setFeedback({
				            phase1: sintactic ? {
					            ...
					            ...feedback.phase1, outOfBoundsSemantic: feedback?.phase1?.outOfBoundsSemantic == null ? 1 : feedback?.phase1?.outOfBoundsSemantic + 1
				            } : {
